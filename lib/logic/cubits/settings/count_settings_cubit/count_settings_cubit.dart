...
class CountSettingsCubit extends Cubit<CountSettingsState> {
  bool _isDealingOneCard = true;
  bool _isDealingTwoCards = false;
  bool _isDealingFourCards = false;
  CountSettingsCubit()
      : super(CountSettingsState(
          ...
          isDealingOneCard: true,
          isDealingTwoCards: false,
          isDealingFourCards: false,
          hiLoEnabled: true,
          hiOpt1Enabled: false,
          hiOpt2Enabled: false,
          halvesEnabled: false,
  ...
  void setDeckQuantity(value) => emit(CountSettingsState(
        ...
        isSpeedCountRunning: false,
        isDealingOneCard: state.isDealingOneCard,
        isDealingTwoCards: state.isDealingTwoCards,
        isDealingFourCards: state.isDealingFourCards,
  ...
  void toggleDealOneCard(value) => {
        if (value) {_isDealingTwoCards = false},
        if (!value) {_isDealingTwoCards = true},
        emit(CountSettingsState(
          ...
          cardsPerSecond: state.cardsPerSecond,
          isSpeedCountRunning: false,
          isDealingOneCard: value,
          isDealingTwoCards: _isDealingTwoCards,
          isDealingFourCards: _isDealingFourCards,
          hiLoEnabled: state.hiLoEnabled,
          hiOpt1Enabled: state.hiOpt1Enabled,
          hiOpt2Enabled: state.hiOpt2Enabled,
          halvesEnabled: state.halvesEnabled,
  ...
  void toggleDealTwoCards(value) => {
        if (value) {_isDealingOneCard = false},
        if (!value) {_isDealingOneCard = true},
        emit(CountSettingsState(
          deckQuantity: state.deckQuantity,
          deckPenetration: state.deckPenetration,
          showCount: state.showCount,
          ...
          cardsPerSecond: state.cardsPerSecond,
          isSpeedCountRunning: false,
          isDealingOneCard: _isDealingOneCard,
          isDealingTwoCards: value,
          isDealingFourCards: _isDealingFourCards,
          hiLoEnabled: state.hiLoEnabled,
          hiOpt1Enabled: state.hiOpt1Enabled,
          hiOpt2Enabled: state.hiOpt2Enabled,
  ...
  void toggleDealFourCards(value) => {
        if (value) {_isDealingOneCard = false},
        if (!value) {_isDealingOneCard = true},
        emit(CountSettingsState(
          deckQuantity: state.deckQuantity,
  ...
  void toggleHiLo(value) => emit(CountSettingsState(
        deckQuantity: state.deckQuantity,
        deckPenetration: state.deckPenetration,
        showCount: state.showCount,
        speedCountEnabled: state.speedCountEnabled,
  ...
  void exitCountTrainer() => emit(CountSettingsState(
        deckQuantity: state.deckQuantity,
        deckPenetration: state.deckPenetration,
        showCount: state.showCount,
        speedCountEnabled: state.speedCountEnabled,
